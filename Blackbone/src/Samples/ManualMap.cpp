...
std::vector<DWORD> getpids() {
    ...
    std::vector<std::string> Names = { "valium.exe", "Olympia2.exe", "metin2client.bin", "metin2client.exe", "Anoria2.exe", "Kevra.exe", "Arithra2-Client.exe", "Akeno2_new.exe", "SunshineMt2.exe" };
    for (auto a : Names) {
